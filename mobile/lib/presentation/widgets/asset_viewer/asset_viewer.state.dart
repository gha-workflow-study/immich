...
class AssetViewerStateNotifier extends Notifier<AssetViewerState> {
  ...
  void updateShowingDetailsFromScroll({
    required bool scrollingUp,
    required double offset,
    required double minOffset,
    required double snapOffset,
  }) {
    final showingDetails =
        (scrollingUp && offset > minOffset) || (state.showingDetails && (scrollingUp || offset >= snapOffset * 0.4));
